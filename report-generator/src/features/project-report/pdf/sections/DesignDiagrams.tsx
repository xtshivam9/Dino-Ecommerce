  ...
  return (
    <BookPageLayout chapterTitle="System Design" chapterNum="07">
      ...
      <Text style={styles.paragraph}>
        The Context Diagram provides a high-level overview, showing Dino-Ecommerce as a single process interacting with external entities: Users (Customers), Administrators, and the Stripe Payment Gateway.
      </Text>
      ...
      <Text style={styles.h2}>7.7 Design Summary</Text>
      <Text style={styles.paragraphIndent}>
        The system design artifacts provided a clear, unambiguous roadmap for the implementation phase. By meticulously modeling data flows, entity relationships, and component interactions, the technical complexity of integrating an e-commerce backend was significantly reduced, allowing for a streamlined coding process.
      </Text>
    </BookPageLayout>
  );
}
