...
const figures = [
  ...
  {
    number: "2.2",
    title: "Feature Comparison Radar \u2014 dj-ecommerce vs Shopify",
    page: "15",
  },
  {
    number: "4.1",
  ...
  {
    number: "7.3",
    title: "Level 2 DFD - Workflow Order State Management",
    page: "74",
  },
  ...
  { number: "8.1", title: "AI Model Execution Pipeline", page: "84" },
  { number: "8.2", title: "Deployment Architecture", page: "86" },
  { number: "9.1", title: "Testing Pyramid", page: "89" },
  {
    number: "10.1",
    title: "User Journey Through dj-ecommerce Platform",
    page: "96",
  },
];
